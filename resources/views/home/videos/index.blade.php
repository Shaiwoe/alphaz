...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <div class="mx-auto text-white p-4 sm:p-8 sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12">
        ...
        <div class="flex flex-col w-full items-center gap-4 lg:gap-8 mt-8 lg:mt-20">
            ...
            <p class="text-white dark:text-zinc-900 text-3xl z-20 mt-8 underline underline-offset-8">برترین ویدیو های یک
                ماه گذشته</p>
            ...
            <div class="w-10/12 grid grid-rows-3 grid-flow-col gap-0 z-20 relative overflow-hidden rounded-3xl">
                ...
                <div class="row-span-2 col-span-2">
                    <div class="hover-img">
                        <a href="" class="flex justify-end w-full  z-20">
                            <img class="image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $a['image']) }}"
                                alt="">
                        </a>
                ...
                @if ($b)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $b['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                @if ($c)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $c['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                @if ($d)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $d['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                @if ($e)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $e['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                @if ($f)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('VIDEO_IMAGES_UPLOAD_PATH') . $f['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <div id="coinBox"
                        ...
                        <div class="grid grid-cols-3 gap-4 mt-8">
                            @foreach ($tavs as $tag)
                                <a href="{{ route('home.tavs.show', ['tag' => $tag->slug ? $tag->slug : 'none']) }}"
