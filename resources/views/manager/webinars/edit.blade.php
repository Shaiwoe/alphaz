        ...
        <div class="flex flex-col sm:w-full md:w-9/12 lg:w-10/12 h-full m-0 overflow-hidden overflow-y-auto p-4">
            ...
            <div class="flex flex-col space-y-8 w-full">
                <div class="flex justify-between items-center">
                    <p class="text-xl text-white dark:text-zinc-900">ویرایش {{ $webinar->title }}</p>
                </div>
                {{-- form create article  --}}
                ...
                <form action="{{ route('webinars.update', ['webinar' => $webinar->id]) }}" method="POST"
                    ...
                    <div class="grid lg:grid-cols-3 w-full gap-6  mb-6">
                        ...
                        <div class="flex flex-col w-full">
                            <label for="primary_image" class="block mb-2 text-sm font-medium text-white dark:text-zinc-900">انتخاب
                                عکس</label>
