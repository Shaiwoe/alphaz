                    ...
                    <form action="{{ route('taps.store') }}" method="POST">
                        ...
                        <div class="flex w-full gap-6  mb-6">
                            ...
                            <div class="flex flex-col w-full lg:w-3/12 ">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="block p-2.5 w-full rounded-3xl bg-coin1 dark:bg-slate-200 text-white dark:text-zinc-900 border-gray-600 placeholder-gray-400  focus:ring-yellow-400 focus:border-yellow-400" placeholder="عنوان تگ را وارد کنید" >
