...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <div class="mx-auto text-white p-4 sm:p-8 sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12">
                ...
                @foreach ($articleBanners as $articleBanner)
                    <div class="hover-img">
                        ...
                        <div class="middle space-y-2 lg:space-y-8">
                            ...
                            <div class="text10">
                                <a href="{{ route('home.articles.show', ['article' => $articleBanner->slug]) }}"
                                    class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-button1 text-gray-100 text-center p-2">
        ...
        <div class="flex p-4 mt-16 lg:mt-44 z-40 gap-8 bg-coin1 dark:bg-white relative" id="coinBox">
            ...
            <div class="hidden  lg:flex w-3/12 flex-col p-4 space-y-3 z-40">
                <div class="flex flex-col gap-4">
                    <p class="text-xl">دسته بندی ها</p>
                    <div id="coinBox" class=" rounded-3xl p-2">
            ...
            <div class="flex flex-col w-full lg:w-9/12 min-h-screen">
