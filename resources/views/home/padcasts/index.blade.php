            ...
            <div class="w-10/12 grid grid-rows-3 grid-flow-col gap-0 z-20 relative overflow-hidden rounded-3xl">
                ...
                <div class="row-span-2 col-span-2">
                    <div class="hover-img">
                        <a href="" class="flex justify-end w-full  z-20">
                            <img class="image" src="{{ asset(env('PADCAST_IMAGES_UPLOAD_PATH') . $a['image']) }}"
                                alt="">
                        </a>
                ...
                @if ($b)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('PADCAST_IMAGES_UPLOAD_PATH') . $b['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                @if ($c)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('PADCAST_IMAGES_UPLOAD_PATH') . $c['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <div id="coinBox"
                        ...
                        <div class="grid grid-cols-3 gap-4 mt-8">
                            @foreach ($taps as $tap)
                                <a href="{{ route('home.taps.show', ['tap' => $tap->slug ? $tap->slug : 'none']) }}"
                                    class="bg-box dark:bg-slate-300 rounded-xl text-center p-2 text-sm h-fit">{{ $tap->title }}</a>
                            @endforeach
                        </div>
                    </div>
