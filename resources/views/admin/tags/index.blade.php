            ...
            <div class="flex flex-col w-full h-screen overflow-y-auto p-4">
                ...
                <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                    <div class="flex justify-between items-center">
                        <p class="text-xl">  تگ ها - {{ $tags->total() }}</p>
                        <a href="{{ route('tags.create') }}" class="bg-green-600 px-8 py-2 rounded-md flex gap-2 items-center">
        ...
        <tbody>
            ...
            <tr class=" text-white border-b bg-dark2 dark:border-gray-700 hover:bg-gray-800">
                ...
                <td class="px-6 py-4 flex gap-4">
                    <a class="flex bg-gray-500 text-white px-4 py-2 rounded-md" href="{{ route('tags.show' , ['tag' => $tag->id]) }}">
                        نمایش
                    </a>
