...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <div class="mx-auto text-white p-4 sm:p-8 sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12">
        ...
        <div class="w-full md:basis-2/3 text-white dark:text-gray-700 z-20 gap-8 bg-box dark:bg-white rounded-3xl p-5">

            <div
                class="mb-4 flex justify-between items-center w-full rounded-3xl bg-indigo-1 p-2 lg:p-4 z-20 text-center">
                <ul class="flex flex-wrap -mb-px gap-4 text-center" id="myTab" data-tabs-toggle="#myTabContent"
                    role="tablist">
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="bg-coin1 text-white w-36 p-2 rounded-full" id="dashboard-tab"
                            ...
                            aria-selected="false">بر اساس قدیمی ترین</button>
                    </li>
                    <li class="mr-2" role="presentation">
                    ...
                    <li class="mr-52" role="presentation">
                        <button class="bg-coin1 text-white  p-2 rounded-full" id="width-tab" data-tabs-target="#width"
                            type="button" role="tab" aria-controls="width" aria-selected="false">
