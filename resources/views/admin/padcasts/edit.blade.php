            ...
            <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                ...
                <form action="{{ route('padcasts.update', ['padcast' => $padcast->id]) }}" method="POST"
                    ...
                    <div class="grid grid-cols-4 w-full gap-6  mb-6">
                        ...
                        <div class="flex flex-col w-full">
                            <label for="catepory_id" class="block mb-2 text-sm font-medium text-gray-100 ">نوع دسته
                                بندی</label>
                        ...
                        <div class="flex flex-col w-full">
                            <label for="voice" class="block mb-2 text-sm font-medium text-gray-100">انتخاب
                                پادکست</label>
                    ...
                    <div class="flex flex-col gap-4 w-full">
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="5" type="text" name="description" id="description"
                                class="flex  p-2.5 w-full rounded-lg bg-dark2 focus:ring-yellow-400 focus:border-yellow-400">{{ $padcast->description }}</textarea>
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="8" type="text" name="body" id="body"
                                class="flex  p-2.5 w-full rounded-lg bg-dark2 focus:ring-yellow-400 focus:border-yellow-400">{{ $padcast->body }}</textarea>
