            ...
            <div class="flex flex-col space-y-8 w-full items-center">
                ...
                <div class=" w-full mt-4 tab_wrap tab_area z-40 relative">
                    <div class="btn_area clearfix z-40 flex gap-16 justify-center items-center">
                        <button
                            class="btn_tab_s @if(!$errors->updatePassword->errors()) act @endif btn_tab bg-coin1 dark:bg-slate-200 float-right p-3 backdrop-filter rounded-t-3xl text-white dark:text-zinc-900 flex w-56  justify-center"
                        ...
                        <button
                            class="btn_tab_s @if($errors->updatePassword->errors()) act @endif btn_tab bg-coin1 dark:bg-slate-200 float-right p-3 rounded-t-3xl text-white dark:text-zinc-900 flex w-56 justify-center"
                    ...
                    @if(!$errors->updatePassword->errors())
