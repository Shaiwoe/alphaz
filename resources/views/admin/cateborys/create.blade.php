                ...
                <div class="flex flex-col lg:flex-row w-full gap-6 mt-8 mb-6">
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <input type="slug" name="slug" id="slug" value="{{ old('slug') }}"
                            class="block p-2.5 w-full rounded-lg  border-gray-600 placeholder-gray-400 bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600 focus:ring-yellow-400 focus:border-yellow-400"
                            placeholder="عنوان مقاله را وارد کنید">
