                    ...
                    <div class="flex flex-col gap-4 w-full">
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="5" type="text" name="description" id="description"
                                class="flex  p-2.5 w-full rounded-lg bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600 focus:ring-yellow-400 focus:border-yellow-400">{{ $padcast->description }}</textarea>
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="8" type="text" name="body" id="body"
                                class="flex  p-2.5 w-full rounded-lg bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600 focus:ring-yellow-400 focus:border-yellow-400">{{ $padcast->body }}</textarea>
