                    ...
                    <form action="{{ route('users.update' , ['user' => $user->id ]) }}" method="POST">
                        ...
                        <div class="flex w-full gap-6  mb-6">
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input type="text" name="name" id="name" value="{{ $user->name }}" class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400">
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>

                            <div class="flex flex-col w-full">
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-100 ">ایمیل</label>
                                <input type="text" name="email" id="email" value="{{ $user->email }}" class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400">
                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>

                            <div class="flex flex-col w-full">
                                <label for="role" class="block mb-2 text-sm font-medium text-white">نقش کاربر</label>
                                <select id="role" name="role" class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400">
                                    <option></option>
                            ...
                            <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                                <div class="grid grid-cols-5 gap-4 py-4">
                                    @foreach ($permissions as $permission)
                                        <div class="flex items-center gap-2 px-2 bg-dark2 border-gray-600 rounded-lg text-white">
                        ...
                        <div class="flex gap-4 mt-14">
                            ...
                            <a href="{{ route('users.index') }}" class="bg-red-500 text-center hover:bg-red-600 w-1/12 p-2 rounded-lg">بازگشت</a>
                        </div>
