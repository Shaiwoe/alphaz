        ...
        <div class="flex flex-col sm:w-full md:w-9/12 lg:w-10/12 h-full m-0 overflow-hidden overflow-y-auto p-4">
            ...
            <div class="flex flex-col space-y-8 w-full">
                <div class="flex justify-between items-center">
                    <p class="text-xl  text-white dark:text-zinc-900">ویرایش {{ $book->title }}</p>
                </div>
                {{-- form create article  --}}
                    ...
                    <div class="flex flex-col gap-4 w-full">
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="5" type="text" name="description" id="description"
                                class="flex  p-2.5 w-full rounded-3xl bg-coin1 dark:bg-slate-200 text-white dark:text-zinc-900 focus:ring-yellow-400 focus:border-yellow-400">{{ $book->description }}</textarea>
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="8" type="text" name="body" id="body"
                                class="flex  p-2.5 w-full rounded-3xl bg-coin1 dark:bg-slate-200 text-white dark:text-zinc-900 focus:ring-yellow-400 focus:border-yellow-400">{{ $book->body }}</textarea>
