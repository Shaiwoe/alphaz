...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <div class="flex justify-between  relative space-x-4">
        ...
        <!-- main -->
        <div class="flex flex-col w-full lg:w-10/12 mt-28 h-full min-h-screen justify-center items-center  p-4 ">


            <ol class="relative lg:w-6/12 border-l border-gray-200 dark:border-gray-700">
