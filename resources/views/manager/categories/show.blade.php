            ...
            <div class="flex flex-col w-full h-screen overflow-y-auto p-4">
                ...
                <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                    <div class="flex justify-between items-center">
                        <p class="text-xl">دسته بندی : {{ $category->title }}</p>
                    </div>
                    {{-- form create article  --}}
                        ...
                        <div class="grid grid-cols-3 w-full gap-6  mb-6">
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input type="text" value="{{ $category->title }}" disabled class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400" placeholder="عنوان مقاله را وارد کنید" >

                            </div>

                            <div class="flex flex-col w-full">
                                <label for="slug" class="block mb-2 text-sm font-medium text-gray-100 ">لینک</label>
                                <input type="slug" value="{{ $category->slug }}" disabled class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400" placeholder="عنوان مقاله را وارد کنید" >
                            </div>
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input value="{{ $category->is_active }}" disabled class="flex text-green-400  p-2.5 w-full rounded-lg bg-dark2 items-center justify-center text-center focus:ring-yellow-400 focus:border-yellow-400">
                            </div>

                            <div class="flex flex-col w-full">
                                <label for="is_active" class="block mb-2 text-sm font-medium text-gray-100">تاریخ ایجاد</label>
                                <input value="{{ verta($category->created_at) }}" disabled class="flex  p-2.5 w-full text-sky-400 rounded-lg bg-dark2 items-center justify-center text-center focus:ring-yellow-400 focus:border-yellow-400">
                            </div>

                            <div class="flex flex-col w-full">
                                <label for="is_active" class="block mb-2 text-sm font-medium text-gray-100">تاریخ ویرایش</label>
                                <input value="{{ verta($category->updated_at) }}" disabled class="flex  text-yellow-400 p-2.5 w-full rounded-lg bg-dark2 items-center justify-center text-center focus:ring-yellow-400 focus:border-yellow-400">
                            </div>
