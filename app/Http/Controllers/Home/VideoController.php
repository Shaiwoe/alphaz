...
class VideoController extends Controller
{
    public function index(Video $videos)
    {
        ...
        $tavs = DB::select('select ANY_VALUE(a.title) as title, ANY_VALUE(a.slug) as slug, COUNT(b.tag_id) as total FROM tavs a inner join video_tavs b ON b.tag_id = a.id group by b.tag_id order by total desc limit 15');
