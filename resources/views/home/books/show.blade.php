    ...
    {{-- <div class="sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12 mx-auto p-4 sm:p-8 text-white">
        <div class="flex flex-col space-y-4 sm:space-y-8">
            ...
            <div class="flex justify-center lg:px-36 z-40">
                <img class="w-full  rounded-2xl" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $book->image) }}"
                    alt="{{ $book->title }}">
            </div>
            ...
            <div class="flex flex-col-reverse lg:flex-row w-full gap-10">
                <div
                    ...
                    <p class="bg-coin1 dark:bg-white text-center p-2 rounded-md">اطلاعات کتاب</p>
                    <div class="flex justify-between">
                        <p>زمان انتشار : </p>
                        {{ verta($book->updated_at)->format(' %d / %B / %Y') }}
                    </div>
                    <div class="flex justify-between">
                        <p>زمان مطالعه : </p>
                        {{ $book->time }}
                    ...
                    <a href="{{ asset(env('BOOK_VOICE_UPLOAD_PATH') . $book->voice) }}"
