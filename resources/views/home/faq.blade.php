...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <div class="w-full container flex mx-auto  text-white z-50 p-4">
        <div class="flex flex-col bg-coin1 dark:bg-white w-full p-4 lg:p-12 mt-16 lg:mt-72 z-40" id="coinBox"
            action="">
            <div id="accordion-open" data-accordion="open">

                <h2 id="accordion-open-heading-1">
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 text-xs lg:text-base text-white dark:text-gray-700 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 "
                        data-accordion-target="#accordion-open-body-1" aria-expanded="false"
                        aria-controls="accordion-open-body-1">
                        <span class="flex items-center text-black dark:text-white"><svg class="w-5 h-5 mr-2 shrink-0" fill="currentColor"
                ...
                <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-100 dark:text-gray-200">
                ...
                <h2 id="accordion-open-heading-7">
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 text-xs lg:text-base text-white dark:text-gray-700 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700  dark:hover:bg-gray-800"
