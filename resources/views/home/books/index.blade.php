...
<head>
    ...
    <title>Alpharency | کتاب ها</title>
...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <!-- main -->
    <div class="sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12 mx-auto text-white p-4 sm:p-8">
        ...
        <div class="flex justify-center items-center w-full mt-12">
            <p class="bg-green flex rounded-2xl p-4 text-base mb-4 items-center gap-2 text-white">
                تعداد {{ $booksCount }} کتاب برای این جستجو پیدا شد
            </p>
        </div>
        <?php }?>
        ...
        <div class="flex flex-col w-full items-center gap-4 lg:gap-8 mt-8 lg:mt-20">
            ...
            <p class="text-white dark:text-zinc-900 text-3xl z-20 mt-8 underline underline-offset-8">برترین کتاب های یک
                ماه گذشته</p>
            ...
            <div class="w-10/12 grid grid-rows-3 grid-flow-col gap-0 z-20 relative overflow-hidden rounded-3xl">
                ...
                <div class="row-span-2 col-span-2">
                    <div class="hover-img">
                        <a href="" class="flex justify-end w-full  z-20">
                            <img class="image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $a['image']) }}"
                                alt="">
                        </a>
                        <div class="middle space-y-2 lg:space-y-8">
                            ...
                            <div class="text10">
                                <a href="{{ route('home.books.show', ['book' => $a['slug']]) }}"
                ...
                @if ($b)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $b['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                                ...
                                <div class="text10">
                                    <a href="{{ route('home.books.show', ['book' => $b['slug']]) }}"
                                        class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-green text-white text-center p-2">
                                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if ($c)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $c['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                                ...
                                <div class="text10">
                                    <a href="{{ route('home.books.show', ['book' => $c['slug']]) }}"
                                        class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-green text-white text-center p-2">
                                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if ($d)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $d['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                                ...
                                <div class="text10">
                                    <a href="{{ route('home.books.show', ['book' => $d['slug']]) }}"
                                        class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-green text-white text-center p-2">
                ...
                @if ($e)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $e['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                                ...
                                <div class="text10">
                                    <a href="{{ route('home.books.show', ['book' => $e['slug']]) }}"
                                        class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-green text-white text-center p-2">
                                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor" class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if ($f)
                    <div class="col-span-1">
                        <div class="hover-img">
                            <a href="" class="flex justify-end w-full z-20">
                                <img class=" image" src="{{ asset(env('BOOK_IMAGES_UPLOAD_PATH') . $f['image']) }}"
                                    alt="">
                            </a>
                            <div class="middle space-y-2 lg:space-y-8">
                                <div class="text10 text-xs lg:text-xl font-bold">
                                ...
                                <div class="text10">
                                    <a href="{{ route('home.books.show', ['book' => $f['slug']]) }}"
                                        class="flex justify-center gap-2 text-xs lg:text-sm rounded-3xl bg-green text-white text-center p-2">
                                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                            stroke="currentColor" class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex flex-col w-full">
                    ...
                    <div id="coinBox"
                        ...
                        <div class="grid grid-cols-3 gap-4 mt-8">
                            @foreach ($tabs as $tab)
                                <a href="{{ route('home.tabs.show', ['tab' => $tab->slug ? $tab->slug : 'none']) }}"
                                    class="bg-box dark:bg-slate-300 rounded-xl text-center p-2 text-sm h-fit">{{ $tab->title }}</a>
                            @endforeach
                        </div>
                    </div>
