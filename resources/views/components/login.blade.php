                        ...
                        <div class="hidden p-4 rounded-lg " id="login" role="tabpanel"
                            ...
                            <form class="rounded-xl w-full space-y-6" method="POST" action="{{ route('login') }}">
                                ...
                                <div>
                                    ...
                                    <input id="email"
                                        class="block  dark:bg-coin1 text-white rounded-full mt-2 w-full text-right" type="email"
                                ...
                                <div class="mt-4">
                                    ...
                                    <input id="password"
                                        class="block  dark:bg-coin1 text-white rounded-full mt-2 w-full text-right" type="password"
