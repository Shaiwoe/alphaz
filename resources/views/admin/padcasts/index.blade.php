        ...
        <div class="flex flex-col w-full lg:w-10/12 mt-28 h-full  p-4 min-h-screen">
            ...
            <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                <div class="flex justify-between items-center">
                    <p class="text-xl  text-white dark:text-gray-600"> پادکست ها - {{ $padcasts->total() }}</p>
                    ...
                    <table class="w-full text-right bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600">
                        ...
                        <tbody>
                            @foreach ($padcasts as $key => $padcast)
                                <tr
                                    class=" border-b bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600 dark:border-gray-700 hover:bg-gray-800">
                                    <td class="px-6 py-4">
