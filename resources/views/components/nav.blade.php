<div class="h-screen px-5 py-4  relative hidden md:block">
    <div class="bg-dark2 h-full overflow-auto shadow-xl rounded-lg z-50  w-56">
        <div class="flex flex-col">
            <a href="{{ route('home.index') }}" class="flex justify-center items-center mt-8 px-4">
                <image class="w-44" src="/image/logo-dark.png" alt="">
            </a>
