        ...
        <div class="flex flex-col w-full lg:w-10/12 mt-28 h-full  p-4 min-h-screen">
            ...
            <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                <div class="flex justify-between items-center">
                    <p class="text-xl">ویرایش {{ $book->title }}</p>
                </div>
                {{-- form create article  --}}
                    ...
                    <div class="flex flex-col gap-4 w-full">
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="5" type="text" name="description" id="description"
                                class="flex  p-2.5 w-full rounded-lg bg-dark2 focus:ring-yellow-400 focus:border-yellow-400">{{ $book->description }}</textarea>
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <textarea rows="8" type="text" name="body" id="body"
                                class="flex  p-2.5 w-full rounded-lg bg-dark2 focus:ring-yellow-400 focus:border-yellow-400">{{ $book->body }}</textarea>
