                    ...
                    <table class="w-full text-right bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600">
                        ...
                        <tbody>
                            @foreach ($Categorys as $key => $category)
                                <tr
                                    class="bg-coin1 dark:bg-gray-100 text-white dark:text-gray-600 border-b bg-dark2 dark:border-gray-700 hover:bg-gray-400">
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div
                                            class="{{ $category->getRawOriginal('is_active') ? 'text-green-500' : 'text-red-500' }}">
                                            {{ $category->is_active }}
                                        </div>
                                    </td>
