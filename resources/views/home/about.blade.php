...
<head>
    ...
    <title>Alpharency | درباره ما</title>
...
<body class="bg-indigo-1 dark:bg-white">
    ...
    <div class="p-4 sm:p-8 sm:w-full md:w-10/12 xl:w-10/12 xl2:w-9/12 mx-auto text-white sm:flex-wrap-reverse  flex md:flex-nowrap">
