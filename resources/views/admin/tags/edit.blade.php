            ...
            <div class="flex flex-col w-full h-screen overflow-y-auto p-4">
                ...
                <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                    <div class="flex justify-between items-center">
                        <p class="text-xl">ویرایش تگ {{ $tag->title }}</p>
                    </div>
                    {{-- form create article  --}}
                    ...
                    <form action="{{ route('tags.update' , ['tag' => $tag->id ]) }}" method="POST">
                        ...
                        <div class="flex w-full gap-6  mb-6">
                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <input type="text" name="title" id="title" value="{{ $tag->title }}" class="block p-2.5 w-full rounded-lg bg-dark2 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-400 focus:border-yellow-400" placeholder="عنوان تگ را وارد کنید" >
