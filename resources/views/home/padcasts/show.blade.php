...
<body class="bg-indigo-1 dark:bg-white1">
    ...
    <!-- main -->
    {{-- <div class="sm:w-full lg:w-10/12 xl:w-10/12 xl2:w-9/12 mx-auto p-4 sm:p-8 text-white">
        <div class="flex flex-col space-y-4 sm:space-y-8">
            ...
            <div class="flex justify-center  max-h-72 z-40 ">
                <img class="w-full lg:w-9/12 flex   rounded-2xl"
                    src="{{ asset(env('PADCAST_IMAGES_UPLOAD_PATH') . $padcast->image) }}" alt="{{ $padcast->title }}">
            </div>



            <div id="coinBox"
                class="bg-box dark:bg-white w-full flex justify-between text-white dark:text-gray-700    z-30 gap-10 py-4 px-8 rounded-xl">

                <div class="hidden lg:flex cursor-pointer  gap-2 items-center">
                    <p class="mt-1 "> زمان مورد نیاز برای این پادکست : {{ $padcast->time }} </p>
            ...
            <div class="flex flex-col-reverse lg:flex-row w-full gap-10">
                <div
                    class="flex flex-col bg-box dark:bg-white h-full rounded-2xl z-40 p-4 lg:w-3/12 space-y-8 text-white dark:text-gray-600">
