            ...
            <div class="flex flex-col w-full h-screen overflow-y-auto p-4">
                ...
                <div class="flex flex-col space-y-12 w-full px-4 mt-8">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('cateporys.create') }}" class="bg-green-600 px-8 py-2 rounded-md flex gap-2 items-center">
                        ...
                        <table class="w-full text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class=" text-white border-b bg-dark2 dark:border-gray-700 hover:bg-gray-800">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="{{ $catepory->getRawOriginal('is_active') ? 'text-green-500' : 'text-red-500' }}">
                                            {{ $catepory->is_active }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 flex gap-4">
                                        <a class="flex bg-gray-500 text-white px-4 py-2 rounded-md" href="{{ route('cateporys.show' , ['catepory' => $catepory->id]) }}">
                                            نمایش
                                        </a>
                                        <a class="flex bg-green-500 text-white px-4 py-2 rounded-md" href="{{ route('cateporys.edit' , ['catepory' => $catepory->id]) }}">
                                            ویرایش
                                        </a>
                                    </td>
